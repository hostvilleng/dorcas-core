...
CREATE TABLE `payroll_runs` (
  ...
  `status` enum('draft','approved') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tax_authorities` (
  ...
  `default_payment_details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2020-03-09  1:29:03
