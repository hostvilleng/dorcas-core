...
<body>
<span class="preheader">{{ $inviteSubject }}</span>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <table border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td>
                                                                        <a href="{{ $link }}" class="button button--" target="_blank">Respond</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                        ...
                                        <tr>
                                            <td class="attributes_content">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td class="attributes_item"><strong>Login Page:</strong> </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="attributes_item"><strong>Username:</strong> </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
